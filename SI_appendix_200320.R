...
# Senior: Christian K. Tamnes (c.k.tamnes@psykologi.uio.no)
# 
...
# all coauthors of the enigma lifespan group see https://www.biorxiv.org/content/10.1101/2020.02.17.952010v1
# Paul Thompson (pthomp@usc.edu), USC
# Eveline A. Crone (ECrone@FSW.leidenuniv.nl), Leiden Univeristiy
# Sophia Frangou (sophia.frangou@mssm.edu), Icahn School of Medicine at Mount Sinai
